		...
		<div className='cosiness'>
			<div className='container'>
				<div className='cosiness__wrapper'>
					<div className='cosiness__bg'>
						<svg
							width='1366'
							height='1568'
							viewBox='0 0 1366 1568'
							fill='none'
							xmlns='http://www.w3.org/2000/svg'
						>
							<path
								d='M0 266.125C0 252.87 10.7452 242.125 24 242.125H201C214.255 242.125 225 231.38 225 218.125V167.338C225 154.083 235.745 143.338 249 143.338H879C892.255 143.338 903 132.593 903 119.338V24C903 10.7452 913.745 0 927 0H1342C1355.25 0 1366 10.7452 1366 24V1544C1366 1557.25 1355.25 1568 1342 1568H24C10.7452 1568 0 1557.25 0 1544V266.125Z'
								fill='#F7FDFB'
							/>
						</svg>
					</div>
					...
					<div className='cosiness__block'>
						...
						>
							<video ref={videoRef} controls onEnded={handleVideoEnded}>
